...
** To do for 0.6 release
  + [ ] add Monoid for Trail (with cut etc.)
  + [ ] add Turn synonym for CircleFrac
  + [ ] re-export stuff from -core in -lib
  ...
  + [ ] close other tickets with 0.7 milestone
  + [ ] bump versions and deps to 0.7
    + [ ] diagrams-core
    + [ ] diagrams-lib
    + [ ] diagrams-cairo
    + [ ] diagrams-svg
