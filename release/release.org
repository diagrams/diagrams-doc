...
** To do for 0.6 release
  ...
  + [-] update user manual
    ...
    + [X] add "types" section
    + [ ] other updates as needed, see especially intro etc.
  + [ ] clean up ScaleInv and add to manual
  ...
  + [ ] fix/decide what to do re: SVG transparent text
  + [ ] convert force-layout to lens and release
  + [ ] build API docs
  ...
  + [ ] test building with new vector-space (if it's released)
  + [ ] test build:
    - [ ] make testing script -- use cabal-dev -w -j ?
    - [ ] ghc 7.0.4
    - [ ] ghc 7.2.1
    - [ ] ghc 7.4.2
    - [ ] ghc 7.6.1
